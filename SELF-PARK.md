...
| Ephemeral high-churn actors | `actor.WithEphemeral()` spawn option | docs/actor/ephemeral-actors.mdx |
...
go mod edit -replace=github.com/tochemey/goakt/v4=github.com/StringKe/goakt/v4@v4.3.0-sp.1
go mod tidy
```
